        ...
        <div className="md:w-[60%] w-full">
          ...
          <div className={styles.blogContent}>
            <p className={styles.paragraph}>
              Discus fish (Symphysodon) are known as the “Kings of the Aquarium”
              due to their stunning colors and graceful movement. However, their
              beauty comes with a need for strict water conditions to ensure
              their health and longevity. In this guide, we’ll explore
              everything you need to know about maintaining the perfect water
              parameters for Discus fish and how to create a thriving
            ...
            <p className={styles.Heading2Paragraph}>
              ...
              Unlike hardy species, Discus are sensitive to fluctuations in pH,
              temperature, and water hardness, making it essential to maintain a
              stable and clean habitat. Poor water conditions can lead to
              stress, diseases, and even death.
            </p>
            ...
            <ul className={styles.listUl}>
              <li>
                Ammonia and Nitrites: 0 ppm (Highly toxic, must be eliminated).
              </li>

              <li>
                Nitrates: Below 10-20 ppm (High levels can cause health issues).
              </li>
            ...
            <ul className={styles.listUl}>
              <li>
                Use a sponge filter or canister filter to maintain crystal-clear
                water.
              </li>

              <li>Avoid excessive water flow, as Discus prefer calm waters.</li>
            </ul>
            <h3 className={styles.listTitle}>
            ...
            <ul className={styles.listUl}>
              ...
              <li>
                They also release tannins, which have antibacterial properties.
              </li>
            </ul>
            <h3 className={styles.listTitle}>
            ...
            <p className={styles.Heading2Paragraph}>
              Maintaining the perfect water conditions is key to keeping Discus
              fish healthy, vibrant, and stress-free. Regular monitoring, proper
              filtration, and consistent maintenance will ensure your Discus
              thrive in their aquarium. By following these guidelines, you can
              create a stable and natural environment that mimics their
              Amazonian origins.
            </p>
          </div>
        </div>
